...
class Bird(pygame.sprite.Sprite):
    ...
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)  # inicializador da super classe
...
class Pipe(pygame.sprite.Sprite):
    def __init__(self, inverted, xpos, ysize):
        ...
        self.image = pygame.image.load(r'images\pipe-red.png').convert_alpha()
...
class Ground(pygame.sprite.Sprite):
    def __init__(self, xpos):
        ...
        self.image = pygame.image.load(r'images\base.png').convert_alpha()
